...
async function initMap() {
    ...
    shopsLinks.forEach(shop => {
        ...
        shopMarker.setAttribute("href", shop[2]);   
    });
    ...
    // content.setAttribute("class", "geoPoint");
    // content.setAttribute("href", "http://localhost/");
    // content.innerHTML = "";
}
